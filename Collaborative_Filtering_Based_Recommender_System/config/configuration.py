...
from Collaborative_Filtering_Based_Recommender_System.utils.util import read_yaml_file
from Collaborative_Filtering_Based_Recommender_System.exception.exception_handler import AppException
from Collaborative_Filtering_Based_Recommender_System.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig, ModelRecommendationConfig
from Collaborative_Filtering_Based_Recommender_System.constant import *
...
class AppConfiguration:
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            # Constructing paths for transformed data and trained model
